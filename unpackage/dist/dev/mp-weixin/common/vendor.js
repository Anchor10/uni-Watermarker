...
_vue.default.prototype.$baseUrl = 'https://api.dspqsy.com/index.php';
_vue.default.prototype.$uniRequest = function (url, param, func, flag) {
  (0, _request.default)(url, param, func, flag);
};
